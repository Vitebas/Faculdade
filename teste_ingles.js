const questions = [
    {
        question: "George is ___________ .",
        answers: [
            { text: "a engineer", correct: false },
            { text: "an engineer", correct: true },
            { text: "engineer", correct: false },
            { text: "one engineer", correct: false }
        ]
    },
    {
        question: "Helen _______ shopping every week.",
        answers: [
            { text: "goes", correct: true },
            { text: "go", correct: false },
            { text: "is going", correct: false },
            { text: "is goes", correct: false }
        ]
    },
    {
    ...
    {
        question: "I didn't _______ TV last night.",
        answers: [
            { text: "watching", correct: false },
            { text: "was watching", correct: false },
    ...
    {
        question: " _______ brothers and sisters do you have?",
        answers: [
